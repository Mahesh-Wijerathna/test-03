const UserModel = require('../model/medicalCenter')
...
exports.register = async (req, res, next) => {
    ...
    const medicalCenterRegistrationId = req.body.medicalCenterRegistrationId;
    ...
    const nearestDestination = req.body.nearestDestination;
    const medicalCenterMedia = req.body.medicalCenterMedia;
    ...
    try {
        ...
        if (!medicalCenterRegistrationId 
            || !name 
            || !ownerName 
            || !address 
            || !email 
        ...
        const user = new UserModel({
            ...
            medicalCenterRegistrationId : medicalCenterRegistrationId,
            name : name,
            ownerName : ownerName,
            address : address,
            email : email,
            ...
            medicalCenterMedia : medicalCenterMedia
        })
